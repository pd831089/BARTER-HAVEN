...
const NotificationCenter = ({ visible, onClose }) => {
  ...
  // Refresh notifications when the modal opens to avoid heavy work on press
  useEffect(() => {
    if (visible) {
      // Defer to next frame to keep UI responsive
      requestAnimationFrame(() => refreshNotifications());
    }
  }, [visible]);
